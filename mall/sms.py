...
def _load_nalo_config():
    ...
    Returns (username, password, sender_id, api_url) or (None, None, None, None).
    """
    try:
    ...
    return username, password, sender_id, api_url
...
def send(phone, text):
    ...
    nalo_user, nalo_pass, _, _ = _load_nalo_config()
...
def _send_nalo(phone, text):
    ...
    Body (JSON): { "key": "<username>", "msisdn": "<phone>", "message": "<text>",
                    "sender_id": "<sender>" }
    ...
    """
    username, password, sender_id, api_url = _load_nalo_config()
    if not username or not password:
        return False
