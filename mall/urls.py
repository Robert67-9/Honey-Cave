...
urlpatterns = [
    ...
    path('panel/seller-incidents/', return_views.admin_seller_incidents, name='admin_seller_incidents'),
    path('panel/seller-incidents/<int:user_id>/', return_views.admin_seller_incident_detail, name='admin_seller_incident_detail'),
    ...
    # Wallets & Payouts — dispute resolution dashboard
    path('panel/wallets/', admin_views.admin_wallets, name='admin_wallets'),
    path('panel/wallets/<int:pk>/', admin_views.admin_wallet_detail, name='admin_wallet_detail'),
    path('panel/withdrawals/', admin_views.admin_withdrawals, name='admin_withdrawals'),
    ...
    path('rider/earnings/',              rider_views.rider_earnings,  name='rider_earnings'),
    path('rider/earnings/withdraw/',     rider_views.rider_withdraw,  name='rider_withdraw'),
    path('rider/earnings/withdraw/confirm/', rider_views.rider_withdraw_confirm, name='rider_withdraw_confirm'),
    ...
    path('officer/auto-login/<str:token>/', fulfillment_officer_views.officer_auto_login, name='officer_auto_login'),
    ...
    path('officer/product/<int:pk>/edit/', fulfillment_officer_views.officer_product_edit, name='officer_product_edit'),
    path('officer/product/<int:pk>/delete/', fulfillment_officer_views.officer_product_delete_confirm, name='officer_product_delete_confirm'),
    path('officer/product/<int:pk>/delete/confirm/', fulfillment_officer_views.officer_product_delete, name='officer_product_delete'),
    path('officer/csv-upload/',       fulfillment_officer_views.officer_csv_upload,         name='officer_csv_upload'),
    path('officer/earnings/',         fulfillment_officer_views.officer_earnings,           name='officer_earnings'),
    path('officer/earnings/withdraw/', fulfillment_officer_views.officer_withdraw,          name='officer_withdraw'),
    path('officer/earnings/withdraw/confirm/', fulfillment_officer_views.officer_withdraw_confirm, name='officer_withdraw_confirm'),
    path('officer/earnings/withdraw/resend/', fulfillment_officer_views.officer_withdraw_resend, name='officer_withdraw_resend'),
    path('officer/earnings/withdraw/<int:pk>/resume/', fulfillment_officer_views.officer_withdraw_resume, name='officer_withdraw_resume'),
