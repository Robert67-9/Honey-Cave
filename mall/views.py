...
def paystack_webhook(request):
    ...
    csrf_exempt is required: Paystack's servers POST here directly and
    send no Referer header, which Django's CSRF middleware was rejecting
    with 403 Forbidden before this fix.
    """
