...
class ShipmentBookingForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'dest_address', 'dest_city', 'dest_country',
            'sender_name', 'sender_email', 'sender_phone',
            'recipient_name', 'recipient_email', 'recipient_phone',
            'package_type', 'weight_kg', 'description',
            'delivery_option', 'pickup_date', 'insurance_required',
        ]
        widgets = {
            'pickup_date': forms.DateInput(attrs={'type': 'date'}),
            'description': forms.TextInput(attrs={'placeholder': 'e.g. Personal gifts and documents'}),
        }
